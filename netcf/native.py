...
libnetcf.ncf_list_interfaces.argtypes = (c_void_p, c_int, POINTER(c_char_p), c_uint)
...
libnetcf.ncf_lookup_by_name.argtypes = (c_void_p, c_char_p)
libnetcf.ncf_lookup_by_name.restype = c_void_p
...
libnetcf.ncf_lookup_by_mac_string.argtypes = (c_void_p, c_char_p, c_int, POINTER(c_void_p))
...
libnetcf.ncf_if_status.argtypes = (c_void_p, POINTER(c_uint))
...
libnetcf.ncf_change_begin.argtypes = (c_void_p, c_uint)
...
libnetcf.ncf_change_rollback.argtypes = (c_void_p, c_uint)
...
libnetcf.ncf_error.argtypes = (c_void_p, POINTER(c_char_p), POINTER(c_char_p))
